...
> Last Updated: 2026-05-07 (Contact share: attach-grid swipe + contact-picker search magnifier heuristics；见 `implementation/2026-05-07-contact-share-reliability.md`)
...
| ------------------------------------------------------------------------------------------------------------------ | ----------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Auto Contact Share (自动推送主管名片)](features/auto-contact-share.md)                                            | ✅ Complete | 2026-05-07 | `AutoContactShareAction`; multi-build attach panel (`ahe`/`aij`, `aha`/`aif`, `igu`); `PageStateValidator` + UI dumps; edge-safe attach-grid swipe; `SearchContactFinder` / `find_search_button` header band `max(22% height, 180px)` + `find_search_input` multi-EditText rules; dedup `media_action_contact_shares`; tests: `test_contact_share_service`, `test_page_state_validator`, `test_ui_search_helpers`, action tests                                                                         |
